...
export default function PptxBuilderPage() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      <h1 className="text-2xl font-bold mb-2">PPTX Builder</h1>
      <p className="text-gray-600 mb-4">
        Write JavaScript code that uses <code>pptxgenjs</code> to build a
        presentation. Define a function <code>buildPresentation(pptxgen)</code>{" "}
        that returns the presentation object.
      </p>
